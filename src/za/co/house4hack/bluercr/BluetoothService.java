...
public class BluetoothService {
	...
	private synchronized void setState(int state) {
		...
		mHandler.obtainMessage(BlueRcrActivity.MESSAGE_STATE_CHANGE,
	...
	public synchronized void connected(BluetoothSocket socket,
		...
		Message msg = mHandler
				.obtainMessage(BlueRcrActivity.MESSAGE_DEVICE_NAME);
		Bundle bundle = new Bundle();
		bundle.putString(BlueRcrActivity.DEVICE_NAME, device.getName());
		msg.setData(bundle);
	...
	private void connectionFailed() {
		...
		Message msg = mHandler
				.obtainMessage(BlueRcrActivity.MESSAGE_TOAST);
		Bundle bundle = new Bundle();
		bundle.putString(BlueRcrActivity.TOAST,
	...
	private class ConnectedThread extends Thread {
		...
		public void write(byte[] buffer) {
			try {
				...
				mHandler.obtainMessage(BlueRcrActivity.MESSAGE_WRITE,
